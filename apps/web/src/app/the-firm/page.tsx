...
export const metadata = {
  title: "The firm",
  description:
    `Meet all ${headcount()} AI specialists: one CMO, four desks, and the one thing each of them will never do. Read straight from the agents' own specs.`,
    ...
    <MarketingChrome>
      ...
      <section className="section fresh-hero">
        ...
        <h1 className="hero-title">
          {headcount()} specialists. <span className="hl">Zero</span> meetings.
        </h1>
        <p className="hero-lede">
          Each one is great at exactly one job, and each one publishes the thing it will never do.
        </p>
      ...
      <section className="section section-alt">
        ...
        <details className="acc" id="cmo" style={{ marginTop: "1.2rem" }}>
          <summary>The CMO&rsquo;s office ({CMO_OFFICE.length})</summary>
        ...
        <details className="acc">
          <summary>Operations ({OPERATIONS.length})</summary>
          <div className="acc-body" style={{ maxWidth: "none" }}>
        ...
        <div style={{ marginTop: "1.8rem" }}>
          {live.map((manager) => (
            <details className="acc" key={manager.key} id={manager.key}>
              <summary>Everyone on {manager.name} ({manager.team.length})</summary>
              <div className="acc-body" style={{ maxWidth: "none" }}>
          ...
          <details className="acc">
            <summary>Why {serverOnly.length} of them don&rsquo;t run in your browser</summary>
            <div className="acc-body">
              ...
              <p className="small muted">This page shows {placed()} of {headcount()} agents, read from the specs the runtime checks at start-up.</p>
            </div>
          </details>
        </div>
      </section>
